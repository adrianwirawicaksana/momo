...
export function SoalGenerator({ modules, moduleId, file, questionCount, isGenerating, questions, onFileChange, onFileRemove, onQuestionCountChange, onModuleChange, onGenerate }: SoalGeneratorProps) {
    return (
